...
name = data1[3].find("strong").text                         # Then after checking the list we can extract our reuired information
...
# Finally insert all the extracted data in a list
buyer = {'Name':name, 'email':email, 'phone':phone}

# Using dumps method from json we the dictionary into json format
s = json.dumps(buyer)
